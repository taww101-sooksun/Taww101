...
st.markdown('<h1 class="neon-title">SYNAPSE.V2</h1>', unsafe_allow_html=True)
...
<head>
    ...
    <style>
        ...
        .visualizer-box { height: 30px; background: #050505; border-radius: 15px; border: 1px solid #222; }
        
        .deck { padding: 20px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.02); }
