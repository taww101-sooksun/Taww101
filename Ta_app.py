...
File "/mount/src/taww101/สี app.py", line 188, in <module>
    user_check = db.reference(f'users/{new_user}').get()
                 ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^
File "/home/adminuser/venv/lib/python3.13/site-packages/firebase_admin/db.py", line 70, in reference
    service = _utils.get_app_service(app, _DB_ATTRIBUTE, _DatabaseService)
File "/home/adminuser/venv/lib/python3.13/site-packages/firebase_admin/_utils.py", line 103, in get_app_service
    app = _get_initialized_app(app)
File "/home/adminuser/venv/lib/python3.13/site-packages/firebase_admin/_utils.py", line 87, in _get_initialized_app
    return firebase_admin.get_app()
           ~~~~~~~~~~~~~~~~~~~~~~^^
File "/home/adminuser/venv/lib/python3.13/site-packages/firebase_admin/__init__.py", line 137, in get_app
    raise ValueError(
