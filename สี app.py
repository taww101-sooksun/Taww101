...
def room_reality_scanner():
    ...
    with col2:
        st.markdown(f'<div class="logic-box" style="border-color:{st.session_state.get("border_color", "#00FF41")};">', unsafe_allow_html=True)
